...
function Header (){
    return(
        <nav id="navbar">
            ...
            <span onClick={Drop} className="menu" id="menu">Menu<img src="https://cdn.jsdelivr.net/gh/orunto/mycdn/gcrib/images/Menu.svg" alt="Menu"></img></span>
            <span onClick={Retract} className="menu" id="menu2">Menu<img src="https://cdn.jsdelivr.net/gh/orunto/mycdn/gcrib/images/cancel.svg" alt="Close"></img></span>
            <span id="search">Search<img src="https://cdn.jsdelivr.net/gh/orunto/mycdn/gcrib/images/Search.svg" alt="Search"></img></span>

            <img onClick={MobileDrop} className="mobilemenu" id="mobilemenu" src="https://cdn.jsdelivr.net/gh/orunto/mycdn/gcrib/images/Menu.svg" alt="Menu"></img>
            <img onClick={MobileRetract} className="mobilemenu" id="mobilemenu2" src="https://cdn.jsdelivr.net/gh/orunto/mycdn/gcrib/images/cancel.svg" alt="Close"></img>
            <img id="mobilesearch" src="https://cdn.jsdelivr.net/gh/orunto/mycdn/gcrib/images/Search.svg" alt="Search"></img>
            <div id="dropdown">
                <ul>
                   <li> <a href="#">Home</a> </li>
                   <li> <a href="#">For You</a> </li>
                   <li> <a href="#">For You +</a> </li>
                   <li id="partners" onClick={ShowPartners}> <a href="#">Partners <img src="https://cdn.jsdelivr.net/gh/orunto/mycdn/gcrib/images/partner.svg" alt="Show"></img></a> </li>
                   <li id="partners2" onClick={HidePartners}> <a href="#">Partners <img src="https://cdn.jsdelivr.net/gh/orunto/mycdn/gcrib/images/partner.svg" alt="Hide"></img></a> </li>
